<template>
    <div class="lv-column-text" :class="[`lv-column-text-${align}`,{'lv-column-text-link':link}]" v-tooltip="{content:showValue,tooltip}">
...
<style lang="scss">
    .lv-column-text {
        ...
        &.lv-column-text-center {
            justify-content: center;
        }
        &.lv-column-text-right {
