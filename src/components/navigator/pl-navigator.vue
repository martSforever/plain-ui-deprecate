<template>
    <div class="pl-navigator">
        <pl-navigator-header :menus="pageStack" :value="currentValue" @input="_clickMenu" @clickClose="_close" ref="header"/>
        <div class="pl-navigator-content">
            ...
            <div class="pl-navigator-content-empty" :class="{'pl-navigator-content-empty-hide':!!pageStack && pageStack.length>0}">
                <link-icon icon="pl-nothing"/>
                <span>空空如也</span>
            </div>
        </div>
    </div>
...
<script>
    ...
    import PlNavigatorHeader from "./pl-navigator-header";

    const TABS_STORAGE_KEY = 'tabs-storage-key';

    export default {
        name: "pl-navigator",
        components: {PlNavigatorHeader},
        props: {
            ...
            transition: {type: String, default: 'pl-navigator-default-animate'},
        },
        watch: {
            value(val) {
...
<style lang="scss">
    .pl-navigator {
        ...
        .pl-navigator-content {
            ...
            .pl-navigator-content-empty {
                ...
                &.pl-navigator-content-empty-hide {
                    opacity: 0;
                    z-index: -1;
                }
            }
    ...
    .pl-navigator-default-animate-enter-active, .pl-navigator-default-animate-leave-active {
        transition: all 0.15s ease
    }

    .pl-navigator-default-animate-enter, .pl-navigator-default-animate-leave-active {
        opacity: 0
    }
</style>