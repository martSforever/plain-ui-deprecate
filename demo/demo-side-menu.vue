                ...
                menuGroups: [
                    ...
                    },
                    {
                        ...
                        menus: [
                            ...
                            {title: 'Icon图标', icon: 'pl-fonticons', page: '/normal/demo-icon', complete: true},
                            {title: 'Button按钮', icon: 'pl-play-circle-solid', page: '/normal/demo-button', complete: true},
                    ...
                    },
                    {
                        ...
                        menus: [
                            ...
                            {title: 'Select下拉选择', icon: 'pl-arrow-down-light', page: '/normal/demo-select', complete: true},
                            {title: 'Cascade级联选择', icon: 'pl-double-arrow-down', page: '/normal/demo-cascade', complete: true},
                    ...
                    },
                    {
                        title: 'Service',
                        menus: [
                            {title: '$message消息服务', icon: 'pl-message', page: '/normal/demo-message', complete: true},
                            {title: '$dialog对话框服务', icon: 'pl-window', page: '/normal/demo-dialog-service', complete: true},
                            {title: '$notice通知', icon: 'pl-bell', page: '/normal/demo-notice', complete: true},
