                ...
                menuGroups: [
                    ...
                    },
                    {
                        ...
                        menus: [
                            ...
                            {title: 'BaseTable列基本属性测试', icon: 'pl-table', page: '/table/demo-base-table-column-prop', complete: true},
                            {title: 'BaseTable基础表格列测试', icon: 'pl-table', page: '/table/demo-base-table-column', complete: true},
                        ],
                    },
                    {
                        title: 'Basic',
                    ...
                    },
                    {
                        ...
                        menus: [
                            ...
                            {title: 'Icon图标', icon: 'pl-fontsize', page: '/normal/demo-icon', complete: true},
                            {title: 'Button按钮', icon: 'pl-play', page: '/normal/demo-button', complete: true},
                    ...
                    },
                    {
                        title: 'Form',
                        menus: [
                            {title: 'Input输入框', icon: 'pl-keyboard', page: '/normal/demo-input', complete: true},
                            {title: 'Textarea文本域', icon: 'pl-keyboard', page: '/normal/demo-textarea', complete: true},
                            {title: 'Radio单复选框', icon: 'pl-radio-on', page: '/normal/demo-radio', complete: true},
                            {title: 'InputNumber数字输入', icon: 'pl-number', page: '/normal/demo-number', complete: true},
                            {title: 'Loading加载', icon: 'pl-loading', page: '/normal/demo-loading', complete: true},
                            {title: 'Select下拉选择', icon: 'pl-arrow-down', page: '/normal/demo-select', complete: true},
                            {title: 'Cascade级联选择', icon: 'pl-cascade', page: '/normal/demo-cascade', complete: true},
                            {title: 'Toggle开关切换', icon: 'pl-toggle', page: '/normal/demo-toggle', complete: true},
                            {title: 'Slider滑块', icon: 'pl-sliders', page: '/normal/demo-slider', complete: true},
                            {title: 'Timer时间选择', icon: 'pl-time', page: '/normal/demo-time', complete: true},
                            {title: 'Date日期选择', icon: 'pl-date', page: '/normal/demo-date', complete: true},
                            {title: 'Rate评分', icon: 'pl-star', page: '/normal/demo-rate', complete: true},
                    ...
                    },
                    {
                        title: 'Service',
                        menus: [
                            {title: '$message消息服务', icon: 'pl-message3', page: '/normal/demo-message', complete: true},
                            {title: '$dialog对话框服务', icon: 'pl-message4', page: '/normal/demo-dialog-service', complete: true},
                            {title: '$notice通知', icon: 'pl-sound-4', page: '/normal/demo-notice', complete: true},
                            {title: '$menu右击菜单', icon: 'pl-sound-4', page: '/normal/demo-context-menu', complete: true},
                        ],
                    },
                    {
                        title: 'Navigation',
                        menus: [
                            {title: 'Tabs页签', icon: 'pl-tab', page: '/normal/demo-tabs', complete: true},
                            {title: 'TabsHeader页签标题', icon: 'pl-tab', page: '/normal/demo-tab-header', complete: true},
                            ...
                            {title: 'Steps步骤条', icon: 'pl-number-list', page: '/normal/demo-step', complete: true},
                        ],
                    },
                    {
                        title: 'Others',
